...
import com.drsync.tourismapp.core.data.source.remote.network.ApiService
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("drysnc".toCharArray())
...
val networkModule = module {
    single {
        ...
        val certifactePinner = CertificatePinner.Builder()
        ...
        OkHttpClient.Builder()
            ...
            .certificatePinner(certifactePinner)
            .build()
    }
    single {
